...
export const Route = createFileRoute("/nervous-system-reset-spring-hill-tn")({
  ...
  component: () => (
    <LocalServicePage
      ...
      intro="A calming, sensory-based scalp and relaxation treatment in Spring Hill, Tennessee designed to support nervous system regulation, stress relief, and deep relaxation. 45 minutes • $120 • Private studio."
      heroImage={heroImage}
